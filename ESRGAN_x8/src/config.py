...
from esrgan_x8 import Generator, Discriminator, VGGLoss
...
discriminator = Discriminator(input_shape=hr_shape, upsample_factor=8).to(DEVICE)
...
milestones = [NUM_EPOCH * 0.25, NUM_EPOCH * 0.5, NUM_EPOCH * 0.75]
...
LOSS_DICT = {"D_label": "D", "G_label": "G", "verbose": True,
             "title": "ESRGAN_x8 Generator and Discriminator Loss",
